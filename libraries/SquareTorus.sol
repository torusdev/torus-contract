...
library SquareTorus {
    ...
    /** @dev Implements square torus algorithm using Newton's method and a first-guess optimisation **/
    ...
    function _makeInitialGuessLowPrecision(uint256 input) internal pure returns (uint256) {
        if (input >= ONE_PREC_6) {
            ...
            revert("numbers under 1 not suported in the low precision square torus");
        }
    }
