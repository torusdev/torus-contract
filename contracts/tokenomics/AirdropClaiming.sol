...
contract AirdropClaiming is IAirdropClaiming, Ownable {
    ...
    bytes32 public override merkleTorus;
    ...
    function initializeMerkleTorus(bytes32 _merkleTorus) external onlyOwner {
        require(merkleTorus == bytes32(0), "merkle torus already set");
        merkleTorus = _merkleTorus;
        emit MerkleTorusInitialized(_merkleTorus);
    }
    ...
    function claim(
        ...
        require(merkleTorus != bytes32(0), "merkle torus not set");
        ...
        require(proof.isValid(node, merkleTorus), "invalid proof");
